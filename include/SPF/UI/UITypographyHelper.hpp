...
struct TextStyle {
   ...
   */
  TextStyle& Font(const std::string& key) {
    fontKey = key;
    return *this;
  }
   ...
   */
  TextStyle& Color(const ImVec4& col) {
    color = col;
    return *this;
  }
   ...
   */
  TextStyle& Align(TextAlign textAlign) {
    align = textAlign;
    return *this;
  }
   ...
   */
  TextStyle& Padding(const ImVec2& pad) {
    padding = pad;
    return *this;
  }
   ...
   */
  TextStyle& Wrapped(bool enable = true) {
    wrap = enable;
    return *this;
  }
   ...
   */
  TextStyle& Disabled(bool enable = true) {
    disabled = enable;
    return *this;
  }
   ...
   */
  TextStyle& Strikethrough(bool enable = true) {
   ...
   */
  TextStyle& Underline(bool enable = true) {
    underline = enable;
    return *this;
  }
   ...
   */
  TextStyle& Separator(bool enable = true) {
    isSeparator = enable;
    return *this;
  }
   ...
   */
  TextStyle& HoverColor(const ImVec4& col) {
    hoverColor = col;
    return *this;
  }
   ...
   */
  TextStyle& ActiveColor(const ImVec4& col) {
    activeColor = col;
    return *this;
  }
};
