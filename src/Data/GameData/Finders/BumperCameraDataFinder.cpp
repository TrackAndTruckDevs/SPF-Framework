...
bool BumperCameraDataFinder::TryFindOffsets(GameDataCameraService& owner) {
  ...
  // ── Phase 1: Camera Reflection Attributes ──
  {
    ...
    // vehicle_bumper_camera SII Attributes
  ...
  m_isReady = (owner.GetBumperOffsetXOffset() != 0 && owner.GetCameraFovOffset() != 0 && owner.GetShakeAnimStepOffset() != 0 && owner.GetShakeAnimScaleMinOffset() != 0 && owner.GetShakeAnimScaleMaxOffset() != 0 && owner.GetShakeAnimOffset() != 0);
