...
static std::string ResolveSCSUnitName(uint32_t unitId) {
  ...
  if (tableAddr == 0) {
    ...
    tableAddr = base + 0x2EEF690;  // Hydra raw RVA: GetOrCreateSCSUnitPool @ LEA RSI,[RCX + 0x2eef630]
  }
  ...
  // itemSize is at +0x88 (Hydra: GetOrCreateSCSUnitPool @ 0x14012593d / 0x1401259f0)
  uint64_t itemSize64 = *(uint64_t*)(poolPtr + 0x88);
...
intptr_t ClimateService::GetVerOffset(intptr_t offset159, intptr_t offset160) const { return IsVersion1_60() ? offset160 : offset159; }
...
std::vector<ClimateService::ClimateInfo> ClimateService::GetAvailableClimates() {
  ...
  // Based on FUN_14046e020: 1.59 (+0x130/0x138), 1.60 FUN_1404e4560 (+0x130/0x138)
  uintptr_t arrayPtr = *(uintptr_t*)(env + GetVerOffset(0x130, 0x130));
  uint64_t count = *(uint64_t*)(env + GetVerOffset(0x138, 0x138));

  uintptr_t unitTableAddr = (uintptr_t)GetModuleHandleA(NULL) + 0x2EEF690;  // Hydra raw RVA: GetOrCreateSCSUnitPool @ LEA RSI,[RCX + 0x2eef630]
  ...
  if (arrayPtr && count > 0 && count < 512) {
    ...
    for (uint64_t i = 0; i < count; ++i) {
      ...
      if (climateObj) {
        ...
        if (poolPtr) {
          uint8_t itemSize = *(uint8_t*)(poolPtr + 0x88);  // Hydra: GetOrCreateSCSUnitPool @ 0x14012593d / 0x1401259f0
          uintptr_t itemsBase = *(uintptr_t*)(poolPtr + 0x00);
...
Utils::Vector3 ClimateService::GetAmbientColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x48, 0x68), variationIdx); }
...
Utils::Vector3 ClimateService::GetSunColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x168, 0x188), variationIdx); }
...
Utils::Vector3 ClimateService::GetSunDiffuseColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x68, 0x88), variationIdx); }
...
Utils::Vector3 ClimateService::GetSunSpecularColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x88, 0xA8), variationIdx); }
...
Utils::Vector3 ClimateService::GetSkyColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0xE8, 0x108), variationIdx); }
...
Utils::Vector3 ClimateService::GetSkyBottomColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x108, 0x128), variationIdx); }
...
Utils::Vector3 ClimateService::GetSunHaloColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x1A8, 0x1C8), variationIdx); }
...
Utils::Vector3 ClimateService::GetFogColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x248, 0x268), variationIdx); }
...
Utils::Vector3 ClimateService::GetColorBalance(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x5E8, 0x608), variationIdx); }
...
Utils::Vector3 ClimateService::GetMoonColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x1E8, 0x208), variationIdx); }
...
Utils::Vector3 ClimateService::GetMoonHaloColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x208, 0x228), variationIdx); }
...
Utils::Vector3 ClimateService::GetFogColor2(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x268, 0x288), variationIdx); }
...
Utils::Vector3 ClimateService::GetStarmapColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x128, 0x148), variationIdx); }
...
Utils::Vector3 ClimateService::GetStarsColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x148, 0x168), variationIdx); }
...
Utils::Vector3 ClimateService::GetSunshaftColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x628, 0x648), variationIdx); }
...
Utils::Vector3 ClimateService::GetLowIntensityColor(int profileSlot, uint32_t variationIdx) { return GetProfileVec3Internal(GetActiveProfilePtr(profileSlot), GetVerOffset(0x6A8, 0x6C8), variationIdx); }
