/**                                                                                               
 * @file ClimateWindow.cpp                                                                          
 * @brief Implementation of the UI window for Climate manipulation.
 */ 
...
ClimateWindow::ClimateWindow(const std::string& componentName, const std::string& windowId, Data::GameData::ClimateService& climateService)
    : BaseWindow(componentName, windowId), m_climateService(climateService) {
...
const char* ClimateWindow::GetWindowTitle() const {
