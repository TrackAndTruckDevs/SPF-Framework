...
float PerformanceMonitor::GetCurrentFPS() const { return m_currentFPS; }

float PerformanceMonitor::GetRollingMinFPS() const { return m_rollingMinFPS; }

float PerformanceMonitor::GetRollingMaxFPS() const { return m_rollingMaxFPS; }

float PerformanceMonitor::GetRollingAvgFPS() const { return m_rollingAvgFPS; }
...
float PerformanceMonitor::GetGlobalMaxFPS() const { return m_globalMaxFPS; }
