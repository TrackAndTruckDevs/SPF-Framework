...
uintptr_t HooksApi::Hook_FindPattern(const char* signature) { return Utils::PatternFinder::Find(signature); }

uintptr_t HooksApi::Hook_FindPatternFrom(const char* signature, uintptr_t startAddress, size_t searchLength) { return Utils::PatternFinder::Find(startAddress, searchLength, signature); }
...
int32_t HooksApi::Memory_ReadInt32(uintptr_t address) { return Utils::PatternFinder::ReadInt32(address); }

int8_t HooksApi::Memory_ReadInt8(uintptr_t address) { return Utils::PatternFinder::ReadInt8(address); }

int64_t HooksApi::Memory_ReadInt64(uintptr_t address) { return Utils::PatternFinder::ReadInt64(address); }
...
uintptr_t HooksApi::Hook_FindString(const char* str) { return Utils::PatternFinder::FindString(str); }

uintptr_t HooksApi::Hook_FindFunctionByString(const char* str, bool findStart, const char* contextSig, size_t contextRange) { return Utils::PatternFinder::FindFunctionByString(str, findStart, contextSig, contextRange); }

uintptr_t HooksApi::Hook_GetFunctionStart(uintptr_t address) { return Utils::PatternFinder::GetFunctionStart(address); }

uintptr_t HooksApi::Hook_GetFunctionEnd(uintptr_t address) { return Utils::PatternFinder::GetFunctionEnd(address); }
...
uintptr_t HooksApi::Hook_FindVTable(const char* signature, int offsetPos, int instructionSize) { return Utils::PatternFinder::FindVTable(signature, offsetPos, instructionSize); }

uintptr_t HooksApi::Hook_GetVTableFunction(uintptr_t vtableAddr, int index) { return Utils::PatternFinder::GetVTableFunction(vtableAddr, index); }

uintptr_t HooksApi::Hook_FindFunctionByConstant(uint32_t constant, bool findStart) { return Utils::PatternFinder::FindFunctionByConstant(constant, findStart); }

uintptr_t HooksApi::Reflection_GetAttributeOffset(const char* className, const char* attributeName) { return Utils::PatternFinder::FindAttributeOffset(className, attributeName); }
