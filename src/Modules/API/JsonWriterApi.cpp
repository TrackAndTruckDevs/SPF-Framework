...
SPF_JsonValue_Handle* JsonWriterApi::Json_CreateArray() { return reinterpret_cast<SPF_JsonValue_Handle*>(new nlohmann::ordered_json(nlohmann::ordered_json::value_t::array)); }
